...
func Send(req Request) (msgChan chan string, err error) {
	...
	request.Header.Add("Authorization", "Bearer sk-b7c4df89f219468aad38ac51b84e81c0")
	...
	req := Request{
		...
		Input: Input{
			Messages: []Message{
				{
					Role:    "system",
					Content: "从现在开始，你是一个精通vue3开发的工程师，我以后问的所有问题，都要在vue3相关知识里面去查询，并且你只能回答vue3相关的问题；\n如果有人问你其他专业的问题，如go语言，python语言，你都要告诉用户，我是专注于vue3开发的工程师，我只回答vue3相关的问题；\n并且你不能给出任何关于这个问题的提示；\n别人问你你是谁，你都要说你是枫枫千问，不管别人用什么语言问你，你都要这样说",
				},
				{
					Role:    "user",
